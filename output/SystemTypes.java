...
public interface SystemTypes
{
  ...
  { List _results_1 = new Vector();
    ...
    { Assignment a = (Assignment) _l.get(_i);
     _results_1.add(new Integer(a.cost()));
    }
    return _results_1;
  }
  ...
  { List _results_3 = new Vector();
    for (int _i = 0; _i < _l.size(); _i++)
    { Task task_3_xx = (Task) _l.get(_i);
     _results_3.add(new Integer(-task_3_xx.getduration()));
    }
    return _results_3;
  }
  ...
  { List _results_2 = new Vector();
    for (int _i = 0; _i < _l.size(); _i++)
    { Staff staff_2_xx = (Staff) _l.get(_i);
     _results_2.add(new Integer(staff_2_xx.getcostDay()));
    }
    return _results_2;
  }
  ...
  { List _results_0 = new Vector();
    for (int _i = 0; _i < _l.size(); _i++)
    { Task d = (Task) _l.get(_i);
     _results_0.add(new Integer(d.totalDuration()));
    }
    return _results_0;
  }
