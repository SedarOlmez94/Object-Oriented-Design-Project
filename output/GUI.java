...
{ JPanel panel = new JPanel();
  ...
  JButton initialisationButton = new JButton("initialisation");
  JButton clearTasksButton = new JButton("clearTasks");
 ...
 public GUI()
  ...
  panel.add(initialisationButton);
  initialisationButton.addActionListener(this);
  panel.add(clearTasksButton);
  ...
  { if (e == null) { return; }
    ...
    if ("initialisation".equals(cmd))
    {  cont.initialisation() ;  return; } 
    if ("clearTasks".equals(cmd))
    {  cont.clearTasks() ;  return; } 
  }
